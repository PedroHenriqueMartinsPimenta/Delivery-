	...
	?>
			...
			<script type="text/javascript">
				var init = 10;
				var where = "PRODUTOS.CATEGORIAS_CODIGO = <?php echo $categoria?>";
				function mais(){
					init += 10;
					$.post(
